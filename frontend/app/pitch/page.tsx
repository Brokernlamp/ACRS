...
const DEMO = {
  ...
  period: "Last 30 Days",
  kpis: [
    { label: "Total Spend", value: "₹20,48,000", sub: "across 4 campaigns", color: "border-indigo-400" },
    { label: "Total Leads", value: "1,240", sub: "generated this month", color: "border-emerald-400" },
    { label: "Blended CPL", value: "₹1,652", sub: "cost per lead", color: "border-violet-400" },
    { label: "ROAS", value: "4.2x", sub: "return on ad spend", color: "border-rose-400" },
  ],
  campaigns: [
    { name: "Google Search", spend: "₹7,60,000", leads: 580, cpl: "₹1,310", score: 91, trend: "up" },
    { name: "Meta Retargeting", spend: "₹5,04,000", leads: 390, cpl: "₹1,292", score: 88, trend: "up" },
    { name: "Google Display", spend: "₹4,79,000", leads: 180, cpl: "₹2,661", score: 42, trend: "down" },
    { name: "LinkedIn Awareness", spend: "₹3,05,000", leads: 90, cpl: "₹3,389", score: 31, trend: "down" },
  ],
  actions: [
    ...
    { type: "REALLOCATE", icon: "💸", color: "bg-indigo-50 border-indigo-200 text-indigo-800", badge: "bg-indigo-100 text-indigo-700", text: "₹3,46,000 in inefficient spend detected. Shift budget from Google Display → Google Search." },
    ...
    { type: "OPTIMISE", icon: "✂️", color: "bg-red-50 border-red-200 text-red-800", badge: "bg-red-100 text-red-700", text: "Google Display CPL ₹2,661 is 61% above average — reduce bids or tighten audience." },
  ],
  simulation: {
    campaign: "Google Search",
    delta: "+20%",
    spendChange: "+₹1,52,000",
    leadsChange: "+98",
    cplChange: "+₹92",
    summary: "Increasing Google Search budget by 20% is projected to generate 98 additional leads at a marginal CPL of ₹1,550 — still well below your target.",
  },
  predictions: { leads: 310, trend: "📈 Improving", growth: "+8.4%", cpl: "₹1,585", ctr: "2.4%" },
  waste: { total: "₹3,46,000", recoverable: "₹2,07,600", worst: "Google Display" },
  features: [
